 ...
 * generated in the com.ztzf.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWords_QNAME = new QName("http://webService.ztzf.com/", "transWords");
    private final static QName _TransWordsResponse_QNAME = new QName("http://webService.ztzf.com/", "transWordsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ztzf.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.ztzf.com/", name = "transWords")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.ztzf.com/", name = "transWordsResponse")
